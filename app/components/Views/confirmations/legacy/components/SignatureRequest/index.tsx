...
import { PageMeta, SecurityAlertResponse } from './types';
        ...
        >
          <View>
            ...
            <View style={styles.blockaidBannerContainer}>
              <BlockaidBanner
                securityAlertResponse={securityAlertResponse as any}
...
export default (withQRHardwareAwareness as any)((withMetricsAwareness as any)(connect(mapStateToProps)(SignatureRequest as any)));
